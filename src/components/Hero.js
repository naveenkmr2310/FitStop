...
// import image
import Image from '../assets/img/hero/guy2.png';
        ...
        <div className='flex flex-col items-center lg:flex-row lg:items-start pt-32 lg:pt-32'>
          <div className='flex-1 lg:mt-12'>
            <h1
              ...
              data-aos-delay='500'
            >
              Start Healing <br />Your Body & Soul
            </h1>
            <p
              ...
              data-aos-delay='600'
            >
              FitStop: Your One-Stop Destination for Fitness Excellence! It encompasses not only physical exercise but also nutrition, mental wellness, and overall lifestyle choices.
